...
/**
 * Carta genérica para otros tipos de justificación.
 */
const CartaOtros = ({
  perfil,
  form,
    ...
    >
      ...
      <div className="contenido-justificado">
        <p>
          ...
          me dirijo a usted de manera respetuosa para informar lo siguiente:
        </p>
        ...
        {archivo && (
          ...
          >
            ✓ Se adjunta un documento como respaldo adicional para su
            consideración.
          </p>
        )}

        <p>
          Agradezco su atención a la presente y quedo atento(a) para cualquier
          aclaración o documentación adicional que se requiera.
        </p>
      </div>
...
const Firma = ({ perfil }) => (
  <div className="firma-derecha">
    ...
    <p>
      {perfil.rol
        ? perfil.rol.charAt(0).toUpperCase() +
          perfil.rol.slice(1)
        : 'Usuario'}
    </p>
    ...
    <p>
      Dirección: {perfil.direccion || 'Quito'}
    </p>
  </div>
);
